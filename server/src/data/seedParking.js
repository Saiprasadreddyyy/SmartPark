...
export { seedParking };
// import Parking from "../components/models/parking.model.js";
// import Slot from "../components/models/slot.model.js";
// import { populateRedisAvailability } from "../components/services/redisAvailability.service.js";
...
// async function seedParking() {
//   console.log("🌱 Starting parking lot seeding...");

//   // Reset parking data
//   Parking.reset();
//   console.log("✅ Reset parking data");
...
//       }
//     });
//     floor1Slots.push(slot);
//   }

//   Parking.addFloor(1, floor1Slots);
//   console.log(`✅ Created Floor 1 with ${floor1Slots.length} slots`);
...
//       }
//     });
//     floor2Slots.push(slot);
//   }

//   Parking.addFloor(2, floor2Slots);
//   console.log(`✅ Created Floor 2 with ${floor2Slots.length} slots`);

//   // Compute distances
//   console.log("📏 Computing distances...");
//   const allSlots = Parking.getAllSlots();
//   const gates = Object.values(Parking.gates);

//   allSlots.forEach((slot) => {
//     gates.forEach((gate) => {
//       const distance = calculateDistance(slot.coords, gate.coords);
//       Parking.setDistance(slot.id, gate.id, distance);
//     });
//   });

//   console.log(
//     `✅ Computed distances for ${allSlots.length} slots and ${gates.length} gates`
//   );
...
//   console.log(`   Occupied Slots: ${stats.occupiedSlots}`);

//   console.log("\n🎉 Parking lot seeding completed!\n");
// }
